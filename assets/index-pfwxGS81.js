...
aut aut aut maxime quia temporibus ut omnis`}],Pc=({user:e})=>e?V.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}):null,Lc=({comment:e})=>e?V.jsxs("div",{className:"CommentInfo",children:[V.jsx("p",{className:"CommentInfo__name",children:e.name}),V.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email}),V.jsx("p",{className:"CommentInfo__body",children:e.body})]}):null,Tc=({comments:e})=>!e||e.length===0?V.jsx("p",{"data-cy":"NoCommentsMessage",children:"No comments"}):V.jsx("div",{className:"CommentList",children:e.map(t=>V.jsx(Lc,{comment:t},t.id))}),Mc=({post:e})=>{if(!e)return null;const{title:t,body:i,user:n,comments:a}=e;return V.jsxs("div",{className:"PostInfo",children:[V.jsx("h2",{className:"PostInfo__title",children:t}),n?V.jsx(Pc,{user:n}):V.jsx("p",{className:"PostInfo__no-user",children:"No user data"}),V.jsx("p",{className:"PostInfo__body",children:i}),V.jsx(Tc,{comments:a})]})},Dc=({posts:e})=>V.jsx("div",{className:"PostList",children:e.map(t=>V.jsx(Mc,{post:t},t.id))});function Rc(){const e=zc.map(t=>{const i=Ur.find(a=>a.id===t.userId),n=Nc.filter(a=>a.postId===t.id).map(a=>({...a,user:Ur.find(u=>u.id===a.userId)}));return{...t,user:i,comments:n}});return V.jsxs("div",{className:"App",children:[V.jsx("h1",{children:"Static List of Posts"}),V.jsx(Dc,{posts:e})]})}tm(document.getElementById("root")).render(V.jsx(Rc,{}));
